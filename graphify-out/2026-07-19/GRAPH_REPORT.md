...
## Corpus Check
- 256 files · ~86,180 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 960 nodes · 2262 edges · 49 communities (46 shown, 3 thin omitted)
...
1. `SectionCard()` - 32 edges
2. `BaseItemModel` - 31 edges
3. `PrepContext` - 23 edges
4. `NumberField()` - 23 edges
5. `defaultCategoryData()` - 22 edges
6. `prepareVitals()` - 19 edges
7. `TextField()` - 19 edges
8. `prepareSupernatural()` - 18 edges
9. `DpValue` - 18 edges
10. `AnimaItem` - 18 edges
...
Cohesion: 0.06
Nodes (60): combate, costes, descripcion, disciplinaPsi, estilo, fisico, hechizo, kiTab (+52 more)

### Community 1 - "Character Sheet & Tabs"
Cohesion: 0.15
Nodes (14): CharacterSheet, NpcSheet, CHARACTERISTICS, COMBAT_SKILLS, NpcSheetApp(), RESISTANCES, AnimaItemView, ItemOps (+6 more)

### Community 2 - "Character Data & Modifiers"
Cohesion: 0.09
Nodes (30): ArmorPenaltyKind, CharacteristicKey, SECONDARY_ABILITIES_BY_GROUP, SECONDARY_ABILITY_GROUPS, SECONDARY_ABILITY_MAP, SecondaryAbilityDefinition, SecondaryAbilityGroup, ARCHETYPE_LABELS (+22 more)
...
Cohesion: 0.15
Nodes (10): ACTION_LABELS, CONCENTRATION_ROWS, CV_COST_ROWS, PsiquicosTab(), StubPanel(), DifficultyTable(), ROWS, Innato (+2 more)

### Community 13 - "Combat Stats Display"
Cohesion: 0.23
Nodes (9): DpSkill, MagicData, MagicPathData, DevelopmentSystemSlice, SecondaryAbilityData, DpValue, VitalsSystemSlice, ctxFor() (+1 more)
...
Cohesion: 0.13
Nodes (29): getLifePointsBase(), getModifier(), getRegeneration(), lookup1to20(), prepareKi(), getInnateKiAccumulation(), MagicSystemSlice, prepareMagic() (+21 more)

### Community 16 - "Derived Stats Display"
Cohesion: 0.24
Nodes (8): CompendiumEntry, KI_CHARS, KiTab(), PowerTree(), PowerTreeProps, TreeRow, Dot, SectionCardProps
...
Cohesion: 0.11
Nodes (29): prepareCharacteristics(), COMBAT_CHAR, CombatSkillData, CombatSystemSlice, prepareCombat(), AT_TYPES, AtType, ceil10() (+21 more)
...
Cohesion: 0.16
Nodes (11): ACTION_LABELS, MisticosTab(), sign(), SUMMONING_SKILLS, ActiveSpell, ActiveSpellsList(), ActiveSpellsListProps, OnUpdate (+3 more)
...
Cohesion: 0.16
Nodes (17): CharacterSchema, dpRecordField(), dpSkillField(), kiCharField(), characteristicField(), CreatureSchema, DEFAULT_SECONDARY_ABILITIES, CharacteristicData (+9 more)
...
Cohesion: 0.10
Nodes (22): CharacterSheetApp(), TAB_COMPONENTS, ARMOR_TYPE_LABELS, AT_TYPES, CombateTab(), LOCALIZATION_LABELS, SIZE_LABELS, WEAPON_TYPE_LABELS (+14 more)
...
Cohesion: 0.20
Nodes (10): KI_CHAR_KEYS, KiAbilityData, KiCharBreakdown, KiCharKey, KiData, KiSystemSlice, getInnateKiPoints(), KI_ACCUMULATION (+2 more)
...
Cohesion: 0.15
Nodes (15): CategorySystemSource, categorySystemToData(), ImprovementStatus, PHYSICAL_CHARS, prepareSecondaryImprovement(), SecondariesSystemSlice, SecondaryAbilityDef, SecondaryImprovementData (+7 more)
...
Cohesion: 0.31
Nodes (6): PsychicData, PsychicDisciplineData, PsychicInnatoData, PsychicPowerData, ctxFor(), mentalistCategory()

### Community 49 - "Community 49"
Cohesion: 0.13
Nodes (16): CHARS, LEVEL_ADJUSTMENTS, PrincipalTab(), RES, sign(), TRAIT_SUBTYPE_LABELS, SUMMARY_CONFIG, SummaryFieldDef (+8 more)
...
## Knowledge Gaps
- **298 isolated node(s):** `name`, `version`, `description`, `type`, `dev` (+293 more)
...
- **Why does `SectionCard()` connect `Item Sheet Tabs & UI` to `Character Sheet & Tabs`, `Character Data & Modifiers`, `Community 36`, `Characteristics Display`, `Derived Stats Display`, `Community 49`, `Community 25`?**
  _High betweenness centrality (0.028) - this node is a cross-community bridge._
- **Why does `defaultCategoryData()` connect `Community 29` to `Character Data & Modifiers`, `Community 40`, `Community 41`, `Community 43`, `Combat Stats Display`, `Entity Extraction`, `Community 48`, `Community 19`?**
  _High betweenness centrality (0.028) - this node is a cross-community bridge._
- **Why does `CategoryData` connect `Community 43` to `Character Data & Modifiers`, `Item Data Models`, `Community 40`, `Community 41`, `Combat Stats Display`, `Entity Extraction`, `Community 48`, `Community 29`?**
