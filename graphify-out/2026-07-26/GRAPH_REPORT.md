...
## Corpus Check
- 1097 files · ~288,597 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1191 nodes · 2776 edges · 56 communities (52 shown, 4 thin omitted)
...
1. `SectionCard()` - 35 edges
2. `BaseItemModel` - 33 edges
3. `NumberField()` - 25 edges
4. `PrepContext` - 23 edges
5. `defaultCategoryData()` - 22 edges
6. `prepareVitals()` - 21 edges
7. `TextField()` - 21 edges
8. `CreatureModel` - 20 edges
9. `prepareSupernatural()` - 19 edges
10. `prepareCharacteristics()` - 18 edges
...
- `makeMod()` --calls--> `stackTotal()`  [EXTRACTED]
  tests/prep-pipeline.test.ts → src/rules/modifier.ts
...
Cohesion: 0.05
Nodes (59): combate, costes, descripcion, disciplinaPsi, estilo, fisico, hechizo, kiTab (+51 more)

### Community 1 - "Character Sheet & Tabs"
Cohesion: 0.10
Nodes (14): CELL_SEP, CRIT_GRID, HANDS_LABELS, ROW_SEP, SIZE_LABELS, typeBanner(), VALUE_GRID, WeaponBlock() (+6 more)

### Community 2 - "Character Data & Modifiers"
Cohesion: 0.10
Nodes (27): CharacteristicKey, SECONDARY_ABILITIES_BY_GROUP, SECONDARY_ABILITY_GROUPS, SECONDARY_ABILITY_MAP, SecondaryAbilityDefinition, SecondaryAbilityGroup, ARCHETYPE_LABELS, CategorySlot (+19 more)

### Community 3 - "Item Data Models"
Cohesion: 0.05
Nodes (58): ArmorModel, ArmorSchema, armorTypeField(), combatBonusSchema(), descriptionSchema(), mkCostSchema(), BaseItemModel, BaseItemSchema (+50 more)
...
Cohesion: 0.07
Nodes (29): dependencies, react, react-dom, description, devDependencies, @foundryvtt/foundryvtt-cli, fvtt-types, tailwindcss (+21 more)
...
Cohesion: 0.20
Nodes (17): DEFAULT_SECONDARY_ABILITIES, directSkillField(), NpcSchema, prepareCharacteristics(), prepareCombat(), prepareEquipment(), prepareState(), prepareVitals() (+9 more)
...
Cohesion: 0.12
Nodes (27): getActionsPerTurn(), getLifePointsBase(), getModifier(), getMovementSpeed(), getRegeneration(), getRegenerationRow(), lookup1to20(), MOVEMENT_SPEED (+19 more)
...
Cohesion: 0.10
Nodes (20): ActionModBreakdown, COMBAT_CHAR, CombatSystemSlice, EquipBonusData, AT_TYPES, AtType, ceil10(), combineAt() (+12 more)
...
Cohesion: 0.15
Nodes (17): KiDistribution, TechniqueDisadvantageClass, TechniqueDisadvantageDef, TechniqueDisadvantageOption, TechniqueEffectClass, TechniqueEffectDef, TechniqueEffectOption, TechniqueEffectRole (+9 more)
...
Cohesion: 0.08
Nodes (26): ACTION_LABELS, MisticosTab(), sign(), SUMMONING_SKILLS, ACTION_LABELS, CONCENTRATION_ROWS, CV_COST_ROWS, PsiquicosTab() (+18 more)
...
Cohesion: 0.06
Nodes (43): META_LAYOUT, nodeX(), nodeY(), ActiveSpellData, DpSkill, MagicData, MagicPathData, SpellData (+35 more)
...
Cohesion: 0.10
Nodes (24): CharacterSheet, NpcSheet, CHARACTERISTICS, COMBAT_SKILLS, NpcSheetApp(), RESISTANCES, AnimaItemView, CompendiumEntry (+16 more)
...
Cohesion: 0.14
Nodes (16): CharacterSheetApp(), TAB_COMPONENTS, BIO_FIELDS, FAME, GeneralTab(), MONEY, TEXT_BLOCKS, MetamagiaTab() (+8 more)

### Community 40 - "Community 40"
Cohesion: 0.11
Nodes (21): CategoryDevelopment, collectSpends(), DevelopmentData, developmentPointsForLevel(), prepareDevelopment(), ReserveKey, ReserveStatus, DEFAULT_DP_LIMITS (+13 more)

### Community 41 - "Community 41"
Cohesion: 0.26
Nodes (12): analyzeEffect(), buildTechnique(), durationKi(), EffectAnalysis, emptyPerChar(), KI_DISPLAY_ORDER, sumDistribution(), TechniqueEffectCost (+4 more)
...
Cohesion: 0.17
Nodes (16): CategorySystemSource, categorySystemToData(), ImprovementStatus, PHYSICAL_CHARS, prepareSecondaries(), prepareSecondaryImprovement(), SecondariesSystemSlice, SecondaryAbilityDef (+8 more)
...
Cohesion: 0.57
Nodes (5): CharacterSchema, dpRecordField(), dpSkillField(), kiCharField(), equipBonusField()

### Community 49 - "Community 49"
Cohesion: 0.11
Nodes (19): ArmorPenaltyKind, CHARS, PrincipalTab(), RES, sign(), TRAIT_SUBTYPE_LABELS, SUMMARY_CONFIG, SummaryFieldDef (+11 more)

### Community 50 - "Community 50"
Cohesion: 0.13
Nodes (15): TechniqueDuration, addTo(), AREA_EFFECTS, ARMOR_EFFECTS, buildTechniqueProfile(), EFFECT_TARGETS, EXTRA_ATTACK_EFFECTS, EXTRA_DEFENSE_EFFECTS (+7 more)

### Community 51 - "Community 51"
Cohesion: 0.43
Nodes (6): KI_CHAR_KEYS, KiAbilityData, KiCharBreakdown, KiCharKey, KiSystemSlice, KiTechniqueData

### Community 52 - "Community 52"
Cohesion: 0.13
Nodes (26): KiData, prepareKi(), MagicSystemSlice, prepareMagic(), CombatSkillData, DevelopmentSystemSlice, SecondaryAbilityData, prepareSupernatural() (+18 more)
...
Cohesion: 0.24
Nodes (3): ItemWindow, applyPathUpdate(), MockItem

## Knowledge Gaps
- **383 isolated node(s):** `name`, `version`, `description`, `type`, `dev` (+378 more)
...
- **Why does `DamageCalculator()` connect `Derived Stats Display` to `Character Sheet & Tabs`?**
  _High betweenness centrality (0.061) - this node is a cross-community bridge._
- **Why does `SectionCard()` connect `Community 25` to `Item Sheet Tabs & UI`, `Character Sheet & Tabs`, `Character Data & Modifiers`, `Community 36`, `Community 39`, `Community 49`, `Community 53`?**
