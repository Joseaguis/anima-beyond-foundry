# Graph Report - anima-beyond-foundry  (2026-07-16)

## Corpus Check
- 249 files · ~82,096 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 938 nodes · 2136 edges · 50 communities (45 shown, 5 thin omitted)
...
1. `BaseItemModel` - 31 edges
2. `SectionCard()` - 25 edges
3. `prepareSupernatural()` - 22 edges
4. `defaultCategoryData()` - 22 edges
5. `PrepContext` - 21 edges
6. `prepareVitals()` - 19 edges
7. `NumberField()` - 19 edges
8. `AnimaItem` - 18 edges
9. `Detalle por sistema` - 18 edges
10. `prepareCharacteristics()` - 17 edges
...
Cohesion: 0.11
Nodes (25): ItemTabDef, ItemTabProps, CombatStyleTab(), DEGREES, SUBTYPES, DescriptionTab(), ACTIONS, KiAbilityTab() (+17 more)

### Community 1 - "Character Sheet & Tabs"
Cohesion: 0.06
Nodes (37): CharacterSheet, NpcSheet, CharacterSheetApp(), TAB_COMPONENTS, AnimaItemView, CompendiumEntry, ItemOps, ReactSheet (+29 more)

### Community 2 - "Character Data & Modifiers"
Cohesion: 0.10
Nodes (27): ArmorPenaltyKind, CharacteristicKey, DEFAULT_SECONDARY_ABILITIES, SECONDARY_ABILITIES_BY_GROUP, SECONDARY_ABILITY_GROUPS, SECONDARY_ABILITY_MAP, SecondaryAbilityDefinition, SecondaryAbilityGroup (+19 more)

### Community 3 - "Item Data Models"
Cohesion: 0.05
Nodes (55): ArmorModel, ArmorSchema, armorTypeField(), combatBonusSchema(), descriptionSchema(), mkCostSchema(), BaseItemModel, BaseItemSchema (+47 more)
...
Cohesion: 0.06
Nodes (44): ActorSystemMap, ActorType, AnimaActor, AnimaItem, ItemSystemMap, ItemType, GROUP_LABELS, GROUP_ORDER (+36 more)

### Community 15 - "Entity Extraction"
Cohesion: 0.14
Nodes (26): getInnateAct(), getInnateZeon(), getLifePointsBase(), getMagicLevelByInt(), getModifier(), getPotentialIncrementBonus(), getPsychicPotentialByVol(), getRegeneration() (+18 more)

### Community 19 - "Community 19"
Cohesion: 0.11
Nodes (17): CombatSystemSlice, AT_TYPES, AtType, ceil10(), combineAt(), EquipmentSummary, EquipmentSystemSlice, EquippedArmorData (+9 more)
...
Cohesion: 0.40
Nodes (4): OnUpdate, Summon, SummonsList(), SummonsListProps
...
Cohesion: 0.05
Nodes (28): ItemSheet, ItemSheetApp(), NpcSheetApp(), ApplicationV2Like, ReactApplicationMixin(), ActorKey, ACTORS, App() (+20 more)
...
Cohesion: 0.18
Nodes (12): CHARACTERISTICS, COMBAT_SKILLS, RESISTANCES, BIO_FIELDS, FAME, MONEY, TEXT_BLOCKS, BaseFieldProps (+4 more)
...
Cohesion: 0.67
Nodes (4): CharacterSchema, dpRecordField(), dpSkillField(), kiCharField()
...
Cohesion: 0.10
Nodes (27): KI_CHAR_KEYS, KiAbilityData, KiCharBreakdown, KiCharKey, KiData, KiSystemSlice, COMBAT_CHAR, CombatSkillData (+19 more)
...
Cohesion: 0.14
Nodes (19): CategorySystemSource, ImprovementStatus, PHYSICAL_CHARS, prepareSecondaries(), prepareSecondaryImprovement(), SecondariesSystemSlice, SecondaryAbilityData, SecondaryAbilityDef (+11 more)

### Community 44 - "Community 44"
Cohesion: 0.21
Nodes (8): SpecialRulesSection(), CHARS, MONSTER_SUBTYPE_LABELS, PrincipalTab(), RES, sign(), TRAIT_SUBTYPE_LABELS, NumberField()

### Community 48 - "Community 48"
Cohesion: 0.15
Nodes (11): CharacteristicData, MagicPathData, PsychicDisciplineData, PsychicPowerData, CHARACTERISTIC_KEYS, defaultCategoryData(), category(), ctxFor() (+3 more)

### Community 49 - "Community 49"
Cohesion: 0.10
Nodes (20): ITEM_TYPE_LABELS, combate, costes, DEFAULT_TABS, descripcion, estilo, fisico, hechizo (+12 more)

### Community 51 - "Community 51"
Cohesion: 0.23
Nodes (16): prepareCharacteristics(), prepareCombat(), prepareEquipment(), prepareState(), prepareVitals(), stackTotal(), run(), fichaSystem() (+8 more)
...
## Knowledge Gaps
- **296 isolated node(s):** `name`, `version`, `description`, `type`, `dev` (+291 more)
...
- **Why does `defaultCategoryData()` connect `Community 48` to `Character Data & Modifiers`, `Item Data Models`, `Community 38`, `Community 40`, `Community 43`, `Entity Extraction`, `Community 19`, `Community 51`?**
  _High betweenness centrality (0.026) - this node is a cross-community bridge._
- **Why does `SectionCard()` connect `Item Sheet Tabs & UI` to `Character Sheet & Tabs`, `Character Data & Modifiers`, `Community 36`, `Community 39`, `Community 44`, `Community 52`, `Community 21`, `Community 25`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **Why does `CategoryData` connect `Community 43` to `Character Data & Modifiers`, `Item Data Models`, `Community 40`, `Entity Extraction`, `Community 48`?**
