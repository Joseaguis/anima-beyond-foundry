# Graph Report - anima-beyond-foundry  (2026-07-06)

## Corpus Check
- 155 files · ~57,946 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 717 nodes · 1579 edges · 45 communities (40 shown, 5 thin omitted)
...
4. `prepareCombat()` - 17 edges
5. `NumberField()` - 17 edges
6. `AnimaActor` - 17 edges
7. `AnimaItem` - 17 edges
8. `compilerOptions` - 17 edges
9. `Detalle por sistema` - 17 edges
...
- `runPipeline()` --calls--> `prepareDevelopment()`  [EXTRACTED]
  tests/ficha-test01.test.ts → src/actors/creature/prep/development.ts
- `run()` --calls--> `prepareEquipment()`  [EXTRACTED]
  tests/equipment-prep.test.ts → src/actors/creature/prep/equipment.ts
...
Cohesion: 0.14
Nodes (13): combate, costes, descripcion, estilo, fisico, hechizo, kiTab, modificadores (+5 more)

### Community 1 - "Character Sheet & Tabs"
Cohesion: 0.06
Nodes (44): CharacterSheet, NpcSheet, CharacterSheetApp(), TAB_COMPONENTS, capitalize(), Vital, VitalsStrip(), VitalsStripProps (+36 more)
...
Cohesion: 0.08
Nodes (38): ArmorModel, ArmorSchema, armorTypeField(), combatBonusSchema(), descriptionSchema(), mkCostSchema(), BaseItemModel, BaseItemSchema (+30 more)
...
Cohesion: 0.18
Nodes (10): ItemSheet, ITEM_TYPE_LABELS, ItemSheetApp(), DEFAULT_TABS, ITEM_TAB_CONFIG, ApplicationV2Like, ReactApplicationMixin(), ReactItemSheet (+2 more)
...
Cohesion: 0.07
Nodes (40): ActorSystemMap, ActorType, AnimaActor, AnimaItem, ItemSystemMap, ItemType, GROUP_LABELS, GROUP_ORDER (+32 more)

### Community 15 - "Entity Extraction"
Cohesion: 0.14
Nodes (16): CategoryDevelopment, collectSpends(), DevelopmentData, developmentPointsForLevel(), prepareDevelopment(), ReserveKey, ReserveStatus, DEFAULT_DP_LIMITS (+8 more)

### Community 19 - "Community 19"
Cohesion: 0.20
Nodes (10): ARMOR_TYPES, ArmorProtectionTab(), AT_KEYS, LOCALIZATIONS, MagicPathTab(), PhysicalTab(), Field(), Dot (+2 more)
...
Cohesion: 0.24
Nodes (7): ItemTabDef, ItemTabProps, DescriptionTab(), ModifiersTab(), CATEGORIES, SUBTYPES, TraitTab()
...
Cohesion: 0.16
Nodes (11): SUMMARY_CONFIG, SummaryFieldDef, SummaryTab(), CalcTip, CalcTooltip(), CalcTooltipProps, parseTip(), TipRow (+3 more)
...
Cohesion: 0.24
Nodes (18): DEFAULT_SECONDARY_ABILITIES, prepareCharacteristics(), prepareCombat(), prepareSecondaries(), prepareState(), prepareSupernatural(), baseFromDp(), sumPerLevel() (+10 more)
...
Cohesion: 0.21
Nodes (11): CharacterModel, CharacterSchema, dpRecordField(), dpSkillField(), characteristicField(), CreatureModel, CreatureSchema, directSkillField() (+3 more)
...
Cohesion: 0.12
Nodes (16): COMBAT_CHAR, CombatSkillData, DevelopmentSystemSlice, PHYSICAL_CHARS, SecondariesSystemSlice, SecondaryAbilityData, SecondaryAbilityDef, FATIGUE_PENALTIES (+8 more)

### Community 39 - "Community 39"
Cohesion: 0.15
Nodes (14): CombatSystemSlice, AT_TYPES, AtType, ceil10(), combineAt(), EquipmentSummary, EquipmentSystemSlice, EquippedArmorData (+6 more)

### Community 40 - "Community 40"
Cohesion: 0.23
Nodes (9): getLifePointsBase(), getModifier(), getRegeneration(), CharacteristicData, CHARACTERISTIC_KEYS, legacyPrepare(), makeMod(), SECONDARIES (+1 more)

### Community 41 - "Community 41"
Cohesion: 0.18
Nodes (12): BIO_FIELDS, FAME, GeneralTab(), MONEY, TEXT_BLOCKS, ACTIONS, MonsterAbilityTab(), DerivedValue() (+4 more)
...
Cohesion: 0.50
Nodes (3): CombatStyleTab(), DEGREES, SUBTYPES

## Knowledge Gaps
- **257 isolated node(s):** `name`, `version`, `description`, `type`, `dev` (+252 more)
...
- **Why does `AnimaActor` connect `Deep Entity Extraction` to `Item Data Models`, `Character Sheet & Tabs`, `Community 35`?**
  _High betweenness centrality (0.025) - this node is a cross-community bridge._
- **Why does `SectionCard()` connect `Community 19` to `Community 32`, `Character Sheet & Tabs`, `Character Data & Modifiers`, `Community 34`, `Community 36`, `Community 41`, `Community 43`, `Community 44`, `Community 21`?**
  _High betweenness centrality (0.020) - this node is a cross-community bridge._
- **Why does `NumberField()` connect `Community 41` to `Community 32`, `Character Sheet & Tabs`, `Character Data & Modifiers`, `Community 34`, `Community 36`, `Community 43`, `Community 44`, `Community 19`, `Community 21`, `Community 25`?**
