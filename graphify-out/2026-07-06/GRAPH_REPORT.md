...
## Corpus Check
- 152 files · ~54,021 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 700 nodes · 1515 edges · 38 communities (33 shown, 5 thin omitted)
...
7. `Detalle por sistema` - 17 edges
8. `prepareVitals()` - 16 edges
9. `prepareCombat()` - 15 edges
10. `PrepContext` - 15 edges
...
Cohesion: 0.12
Nodes (16): combate, costes, descripcion, estilo, fisico, hechizo, kiTab, modificadores (+8 more)
...
Cohesion: 0.11
Nodes (17): CHAR_OPTIONS, SecondaryAbilitiesProps, ArmorPenaltyKind, CharacteristicKey, DEFAULT_SECONDARY_ABILITIES, SECONDARY_ABILITIES_BY_GROUP, SECONDARY_ABILITY_GROUPS, SECONDARY_ABILITY_MAP (+9 more)

### Community 3 - "Item Data Models"
Cohesion: 0.07
Nodes (40): ArmorModel, ArmorSchema, armorTypeField(), combatBonusSchema(), descriptionSchema(), mkCostSchema(), BaseItemModel, BaseItemSchema (+32 more)
...
Cohesion: 0.05
Nodes (73): CharacterSchema, dpRecordField(), dpSkillField(), characteristicField(), CreatureModel, CreatureSchema, getLifePointsBase(), getModifier() (+65 more)

### Community 19 - "Community 19"
Cohesion: 0.18
Nodes (13): MagicPathTab(), ACTIONS, MonsterAbilityTab(), PhysicalTab(), DAMAGE_TYPES, SIZES, WEAPON_TYPES, WeaponCombatTab() (+5 more)
...
Cohesion: 0.14
Nodes (16): BIO_FIELDS, FAME, GeneralTab(), MONEY, TEXT_BLOCKS, CalcTip, CalcTooltip(), CalcTooltipProps (+8 more)
...
## Knowledge Gaps
- **251 isolated node(s):** `name`, `version`, `description`, `type`, `dev` (+246 more)
...
- **Why does `SectionCard()` connect `Community 19` to `Community 32`, `Character Sheet & Tabs`, `Item Sheet Tabs & UI`, `Community 35`, `Community 36`, `Character Data & Modifiers`, `Community 34`, `Community 21`, `Community 25`?**
  _High betweenness centrality (0.020) - this node is a cross-community bridge._
- **Why does `NumberField()` connect `Community 25` to `Community 32`, `Character Sheet & Tabs`, `Item Sheet Tabs & UI`, `Community 35`, `Community 36`, `Character Data & Modifiers`, `Community 34`, `Community 19`, `Community 21`?**
