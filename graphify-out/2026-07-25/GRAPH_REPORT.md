# Graph Report - anima-beyond-foundry  (2026-07-20)

## Corpus Check
- 259 files · ~91,596 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 993 nodes · 2345 edges · 49 communities (46 shown, 3 thin omitted)
...
8. `CreatureModel` - 18 edges
9. `prepareCombat()` - 18 edges
10. `prepareSupernatural()` - 18 edges
...
Cohesion: 0.06
Nodes (62): combate, costes, descripcion, disciplinaPsi, estilo, fisico, hechizo, kiTab (+54 more)
...
Cohesion: 0.07
Nodes (37): CategorySystemSource, categorySystemToData(), CategorySchema, combatBonusField(), combatCostField(), secondaryBonusField(), secondaryCostField(), ArmorPenaltyKind (+29 more)

### Community 3 - "Item Data Models"
Cohesion: 0.06
Nodes (48): ArmorModel, ArmorSchema, armorTypeField(), combatBonusSchema(), descriptionSchema(), mkCostSchema(), BaseItemModel, BaseItemSchema (+40 more)
...
Cohesion: 0.22
Nodes (21): DEFAULT_SECONDARY_ABILITIES, prepareKi(), prepareCharacteristics(), prepareCombat(), prepareSecondaries(), prepareSecondaryImprovement(), prepareState(), prepareSupernatural() (+13 more)

### Community 13 - "Combat Stats Display"
Cohesion: 0.11
Nodes (27): KI_CHAR_KEYS, KiAbilityData, KiCharBreakdown, KiCharKey, KiData, KiSystemSlice, DpSkill, MagicData (+19 more)

### Community 14 - "Deep Entity Extraction"
Cohesion: 0.06
Nodes (42): ActorSystemMap, ActorType, AnimaActor, AnimaItem, ItemSystemMap, ItemType, GROUP_LABELS, GROUP_ORDER (+34 more)
...
Cohesion: 0.12
Nodes (18): ActionModBreakdown, COMBAT_CHAR, CombatSkillData, CombatSystemSlice, EquipBonusData, AT_TYPES, AtType, ceil10() (+10 more)
...
Cohesion: 0.08
Nodes (27): ACTION_LABELS, MisticosTab(), sign(), SUMMONING_SKILLS, LEVEL_ADJUSTMENTS, ACTION_LABELS, CONCENTRATION_ROWS, CV_COST_ROWS (+19 more)
...
Cohesion: 0.13
Nodes (21): CharacterSchema, dpRecordField(), dpSkillField(), kiCharField(), characteristicField(), CreatureSchema, equipBonusField(), CharacteristicData (+13 more)
...
Cohesion: 0.11
Nodes (20): CharacterSheet, NpcSheet, CharacterSheetApp(), CHARACTERISTICS, COMBAT_SKILLS, NpcSheetApp(), RESISTANCES, AnimaItemView (+12 more)
...
Cohesion: 0.10
Nodes (23): TAB_COMPONENTS, WeaponBlocks(), ARMOR_TYPE_LABELS, AT_TYPES, CombateTab(), LOCALIZATION_LABELS, WEAPON_TYPE_LABELS, BIO_FIELDS (+15 more)

### Community 40 - "Community 40"
Cohesion: 0.16
Nodes (13): CategoryDevelopment, collectSpends(), DevelopmentData, developmentPointsForLevel(), prepareDevelopment(), ReserveKey, ReserveStatus, DEFAULT_DP_LIMITS (+5 more)

### Community 41 - "Community 41"
Cohesion: 0.40
Nodes (3): SUMMARY_CONFIG, SummaryFieldDef, SummaryTab()
...
Cohesion: 0.18
Nodes (12): ImprovementStatus, PHYSICAL_CHARS, SecondariesSystemSlice, SecondaryAbilityData, SecondaryAbilityDef, SecondaryImprovementData, CharacteristicKey, specialRuleFlagValue() (+4 more)
...
Cohesion: 0.21
Nodes (8): CHARS, PrincipalTab(), RES, sign(), TRAIT_SUBTYPE_LABELS, BreakdownRow(), SecondarySkillsTable(), SideLabelTable()

## Knowledge Gaps
- **310 isolated node(s):** `name`, `version`, `description`, `type`, `dev` (+305 more)
...
- **Why does `defaultCategoryData()` connect `Community 29` to `Character Data & Modifiers`, `Community 40`, `Community 43`, `Characteristics Display`, `Combat Stats Display`, `Entity Extraction`, `Community 19`?**
  _High betweenness centrality (0.029) - this node is a cross-community bridge._
- **Why does `SectionCard()` connect `Item Sheet Tabs & UI` to `Character Data & Modifiers`, `Community 36`, `Community 39`, `Community 49`, `Community 25`?**
  _High betweenness centrality (0.028) - this node is a cross-community bridge._
- **Why does `CategoryData` connect `Character Data & Modifiers` to `Item Data Models`, `Community 40`, `Community 43`, `Combat Stats Display`, `Entity Extraction`, `Community 29`?**
