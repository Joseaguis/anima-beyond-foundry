# Graph Report - anima-beyond-foundry  (2026-07-15)

## Corpus Check
- 167 files · ~68,420 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 862 nodes · 1903 edges · 56 communities (49 shown, 7 thin omitted)
...
2. `SectionCard()` - 20 edges
3. `prepareVitals()` - 19 edges
4. `defaultCategoryData()` - 18 edges
5. `PrepContext` - 18 edges
6. `NumberField()` - 18 edges
7. `AnimaItem` - 18 edges
8. `Detalle por sistema` - 18 edges
9. `prepareCombat()` - 17 edges
10. `prepareSupernatural()` - 17 edges
...
- `category()` --calls--> `defaultCategoryData()`  [EXTRACTED]
  tests/multi-category.test.ts → src/actors/creature/prep/types.ts
...
Cohesion: 0.09
Nodes (21): ITEM_TYPE_LABELS, combate, costes, DEFAULT_TABS, descripcion, estilo, fisico, hechizo (+13 more)

### Community 1 - "Character Sheet & Tabs"
Cohesion: 0.06
Nodes (42): CharacterSheet, NpcSheet, TAB_COMPONENTS, capitalize(), Vital, VitalsStrip(), VitalsStripProps, CHARACTERISTICS (+34 more)

### Community 2 - "Character Data & Modifiers"
Cohesion: 0.11
Nodes (25): ArmorPenaltyKind, CharacteristicKey, SECONDARY_ABILITIES_BY_GROUP, SECONDARY_ABILITY_GROUPS, SECONDARY_ABILITY_MAP, SecondaryAbilityDefinition, SecondaryAbilityGroup, ARCHETYPE_LABELS (+17 more)
...
Cohesion: 0.14
Nodes (13): CharacterSheetApp(), ActorKey, ACTORS, App(), buildSheetProps(), character, npc, useActorVersion() (+5 more)
...
Cohesion: 0.06
Nodes (43): ActorSystemMap, ActorType, AnimaActor, AnimaItem, ItemSystemMap, ItemType, GROUP_LABELS, GROUP_ORDER (+35 more)

### Community 15 - "Entity Extraction"
Cohesion: 0.16
Nodes (23): getInnateAct(), getInnateZeon(), getLifePointsBase(), getMagicLevelByInt(), getModifier(), getRegeneration(), INNATE_ACT, INNATE_ZEON (+15 more)

### Community 19 - "Community 19"
Cohesion: 0.13
Nodes (16): COMBAT_CHAR, CombatSkillData, CombatSystemSlice, AT_TYPES, AtType, ceil10(), combineAt(), EquipmentSummary (+8 more)
...
Cohesion: 0.16
Nodes (15): CombatStyleTab(), DEGREES, SUBTYPES, DescriptionTab(), BIO_FIELDS, FAME, GeneralTab(), MONEY (+7 more)
...
Cohesion: 0.39
Nodes (4): AnyRecord, migrateCharacterDp(), migrateDpField(), migrateSecondaryNatural()
...
Cohesion: 0.40
Nodes (4): ARMOR_TYPES, ArmorProtectionTab(), AT_KEYS, LOCALIZATIONS
...
Cohesion: 0.21
Nodes (10): CharacterSchema, dpRecordField(), dpSkillField(), characteristicField(), CreatureModel, CreatureSchema, directSkillField(), NpcSchema (+2 more)
...
Cohesion: 0.15
Nodes (15): CategoryDevelopment, collectSpends(), DevelopmentData, DevelopmentSystemSlice, prepareDevelopment(), ReserveKey, ReserveStatus, baseFromDp() (+7 more)

### Community 41 - "Community 41"
Cohesion: 0.16
Nodes (12): ItemTabDef, ItemTabProps, ACTIONS, KiAbilityTab(), KiEffect, SUBTYPES, MagicPathTab(), ModifiersTab() (+4 more)
...
Cohesion: 0.18
Nodes (15): ImprovementStatus, PHYSICAL_CHARS, prepareSecondaries(), prepareSecondaryImprovement(), SecondariesSystemSlice, SecondaryAbilityData, SecondaryAbilityDef, SecondaryImprovementData (+7 more)

### Community 44 - "Community 44"
Cohesion: 0.17
Nodes (11): SpecialRulesSection(), CHARS, MONSTER_SUBTYPE_LABELS, PrincipalTab(), RES, sign(), TRAIT_SUBTYPE_LABELS, OnUpdate (+3 more)
...
Cohesion: 0.18
Nodes (9): CharacteristicData, FATIGUE_PENALTIES, StatePenalties, StateSystemSlice, MagicPathData, CHARACTERISTIC_KEYS, PrepContext, ctxFor() (+1 more)

### Community 49 - "Community 49"
Cohesion: 0.23
Nodes (10): CategorySystemSource, DEFAULT_SECONDARY_ABILITIES, CategoryData, PdRow, SlotView, fichaSystem(), progression(), runPipeline() (+2 more)

### Community 50 - "Community 50"
Cohesion: 0.24
Nodes (6): ItemSheet, ItemSheetApp(), ApplicationV2Like, ReactApplicationMixin(), ReactItemSheet, ReactItemSheetProps

### Community 51 - "Community 51"
Cohesion: 0.35
Nodes (7): prepareCharacteristics(), prepareCombat(), prepareState(), stackTotal(), run(), runDirect(), makeMod()

### Community 53 - "Community 53"
Cohesion: 0.33
Nodes (5): cloneSource(), findByUuid(), modules, PACK_DOCS, PackDoc

### Community 55 - "Community 55"
Cohesion: 0.50
Nodes (3): CATEGORIES, SUBTYPES, TraitTab()

## Knowledge Gaps
- **286 isolated node(s):** `name`, `version`, `description`, `type`, `dev` (+281 more)
...
- **Why does `defaultCategoryData()` connect `Community 43` to `Character Data & Modifiers`, `Community 38`, `Community 40`, `Entity Extraction`, `Community 48`, `Community 51`, `Community 19`?**
  _High betweenness centrality (0.020) - this node is a cross-community bridge._
- **Why does `MockActor` connect `Community 33` to `Item Sheet Rendering`, `Item Data Models`, `Deep Entity Extraction`?**
  _High betweenness centrality (0.020) - this node is a cross-community bridge._
- **Why does `CategoryData` connect `Community 49` to `Character Data & Modifiers`, `Item Data Models`, `Community 38`, `Community 40`, `Community 43`, `Entity Extraction`, `Community 48`?**
